...
public class MarchingSquares : MonoBehaviour
{
    ...
    [HideInInspector]
    // Holds the indices of vertices for each triangle
    ...
    {
        // If there's a displacement vector passed in, interpolate it between 0 and 1
        if (U != null)
        {
            double max = 0;
        ...
        // Set the corner of each mesh to a color based on stress
